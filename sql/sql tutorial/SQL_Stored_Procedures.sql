...
-- Stored Procedure Example (creates a stored procedure named "SelectAllCustomers" that selects all 
...
-- Example 2 (Execute the stored procedure above as follows)
EXEC SelectAllCustomers

-- Stored Procedure With One Parameter (creates a stored procedure that selects Customers 
